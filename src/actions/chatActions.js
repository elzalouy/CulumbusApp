      ...
      .then(async function ({data: response}) {
        ...
        if (response.startChat.user) {
          ...
          await AsyncStorage.setItem(
            'userData',
            JSON.stringify(response.startChat.user),
          );
    ...
    let id = await client
      ...
      .then(async function ({data: response}) {
        ...
        if (response.startChatSocial.user) {
          ...
          await AsyncStorage.setItem(
            'userData',
            JSON.stringify(response.startChatSocial.user),
          );
...
export const listCountryRestrions = () => {
  ...
  return async (dispatch) => {
    ...
    await client
      .query({
        query: LIST_COUNTRY_RESTRICTIONS,
      })
      .then(async function ({data: response}) {
        console.log(response);
        ...
        dispatch({
          type: RESTRICTIONS,
          restrictions: response.listCountryRestrictions,
        });
