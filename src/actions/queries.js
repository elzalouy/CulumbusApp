...
mutation($name: String!, $email: String!, $mobileNumber: String!,$birthdate: String!, $password: String!){
  register(userInput:{name:$name,email:$email,mobileNumber:$mobileNumber,birthdate:$birthdate, password:$password}){
      token,
      user{
        _id,
        email,
...
mutation($mobileNumber:String!,$code:String!,$password:String!){
  resetPassword(mobileNumber:$mobileNumber,code:$code,password:$password){
      message
  }
}
`;
