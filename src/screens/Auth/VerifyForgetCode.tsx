...
function VerifyForgetCode(props) {
  ...
  if (props.loading !== loading){
    ...
    function forget(code){
      ...
      props.verifyForget(data,props.navigation)
    }
        return (
            ...
            <ImageBackground source={{uri: 'img2'}} style={styles.container}>
                <View style={styles.header}>
                    ...
                    <Text style={styles.txt2}>{props.route.params.message}</Text>
                </View>
               ...
               <ActivityIndicator style={{marginTop:w*0.5}} size="large" color="#203152" />
                ...
                <View style={styles.form} >
                     <CodeInput
                    // ref="codeInputRef1"
                    containerStyle={{marginTop:w*0.1}}
                    secureTextEntry
                    borderType={'square'}
                    space={w*0.02}
                    codeLength={4}
                    ...
                    inputPosition='left'
                    activeColor="white"
                    inactiveColor="#7C8698"
                    codeInputStyle={{backgroundColor:'#7C8698',borderRadius:10,borderWidth:0,fontSize:normalize(20)}}
                    onFulfill={(code) => forget(code)}
...
export default connect(mapStateToProps, actions)(VerifyForgetCode);