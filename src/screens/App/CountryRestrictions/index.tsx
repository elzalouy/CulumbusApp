                ...
                <View style={styles.header}>
                  ...
                  <View style={{ paddingTop: w * 0.04, marginLeft: w * 0.03 }}>
                    ...
                    <View style={{ flexDirection: 'row' }}>
                      ...
                      {item.date ?
                        <Text style={styles.lastUpdated}>Last updated at: {item.date}</Text>
                            ...
                            : selected[index] == 5 ?
                              ...
                              : selected[index] == 6 ?
                                ...
                                : selected[index] == 7 ?
                                  ...
                                  : selected[index] == 8 ?
                                    <View style={styles.textContainer}>
                                      <Text style={styles.txt2}>Remarks</Text>
                                      <Text style={styles.txt3}>{item.remarks}</Text>
                                    </View>
                                    : selected[index] == 9 ?
                                      <View style={styles.textContainer}>
                                        <Text style={styles.txt2}>Last updated</Text>
