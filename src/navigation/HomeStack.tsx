...
import AdrenalineEvents from '../screens/App/AdrenalineEvents';
import AdrenalineCityEvents from '../screens/App/AdrenalineEvents/cityEvents';
  ...
  <View style={{flex: 1, paddingBottom: w * 0.25, backgroundColor: 'white'}}>
    <HomeStack.Navigator
      ...
      <HomeStack.Screen
        options={{headerShown: false}}
        name="CityOfTheDay"
        component={CityOfTheDay}
      />
      <HomeStack.Screen
        options={{headerShown: false}}
        name="AdrenalineEvents"
        component={AdrenalineEvents}
      />
      <HomeStack.Screen
        options={{headerShown: false}}
        name="AdrenalineCityEvents"
        component={AdrenalineCityEvents}
      />
